  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u2" class="ax_shape">
        <img id="u2_img" class="img " src="images/payment/u2.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u10" class="ax_paragraph">
        ...
        <div id="u11" class="text">
          <p style="font-size:16px;"><span style="font-size:16px;">Price</span><span style="font-size:13px;">:</span></p>
        </div>
      </div>
      ...
      <div id="u12" class="ax_paragraph">
        ...
        <div id="u13" class="text">
          <p style="font-size:16px;"><span style="font-size:16px;">Quantity</span><span style="font-size:13px;">:</span></p>
        </div>
      </div>
      ...
      <div id="u21" class="ax_html_button">
        <input id="u21_input" type="submit" value="Submit"/>
      </div>

      <!-- Unnamed (HTML Button) -->
      <div id="u22" class="ax_html_button">
        <input id="u22_input" type="submit" value="Reset"/>
      </div>
      ...
      <!-- Unnamed (Menu) -->
      <div id="u25" class="ax_menu">
        <img id="u25_menu" class="img " src="images/index/u6_menu.png" alt="u25_menu"/>

        <!-- Unnamed (Table) -->
        <div id="u26" class="ax_table">
          ...
          <div id="u33" class="ax_table_cell">
            <img id="u33_img" class="img " src="images/index/u14.png"/>
            <!-- Unnamed () -->
        ...
        <div id="u35" class="ax_menu sub_menu">
          <img id="u35_menu" class="img " src="images/index/u16_menu.png" alt="u35_menu"/>
          ...
          <div id="u36" class="ax_table">
            ...
            <div id="u39" class="ax_table_cell">
              <img id="u39_img" class="img " src="images/index/u18.png"/>
              <!-- Unnamed () -->
            ...
            <div id="u41" class="ax_table_cell">
              <img id="u41_img" class="img " src="images/index/u14.png"/>
              <!-- Unnamed () -->
        ...
        <div id="u43" class="ax_menu sub_menu">
          <img id="u43_menu" class="img " src="images/index/u24_menu.png" alt="u43_menu"/>
          ...
          <div id="u44" class="ax_table">
            ...
            <div id="u45" class="ax_table_cell">
              <img id="u45_img" class="img " src="images/index/u26.png"/>
              <!-- Unnamed () -->
            ...
            <div id="u47" class="ax_table_cell">
              <img id="u47_img" class="img " src="images/index/u28.png"/>
              <!-- Unnamed () -->
            ...
            <div id="u49" class="ax_table_cell">
              <img id="u49_img" class="img " src="images/index/u30.png"/>
              <!-- Unnamed () -->
            ...
            <div id="u51" class="ax_table_cell">
              <img id="u51_img" class="img " src="images/index/u32.png"/>
              <!-- Unnamed () -->
