...
<html>
  <head>
    ...
    <link href="files/inventory/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/inventory/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u0" class="ax_shape">
        <img id="u0_img" class="img " src="images/inventory/u0.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u2" class="ax_shape">
        <img id="u2_img" class="img " src="images/inventory/u2.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u17" class="ax_shape">
        <img id="u17_img" class="img " src="images/inventory/u17.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u22" class="ax_html_button">
        <input id="u22_input" type="submit" value="search"/>
      </div>

      <!-- Unnamed (Shape) -->
      <div id="u23" class="ax_shape">
        <img id="u23_img" class="img " src="images/inventory/u23.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (Text Field) -->
      <div id="u35" class="ax_text_field">
      ...
      <div id="u37" class="ax_radio_button">
        <label for="u37_input">
          <!-- Unnamed () -->
        ...
        <input id="u37_input" type="radio" value="radio" name="choice"/>
      </div>

      <!-- Unnamed (Radio Button) -->
      <div id="u39" class="ax_radio_button">
        <label for="u39_input">
          <!-- Unnamed () -->
        ...
        <input id="u39_input" type="radio" value="radio" name="choice"/>
      </div>
